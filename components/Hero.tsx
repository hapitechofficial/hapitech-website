...
const Hero = () => {
  ...
  return (
    <>
      ...
      <div className="absolute inset-0 w-full h-full sm:hidden bg-gradient-to-b from-beige via-transparent to-orange/10" />

      {/* Main Content */}
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 py-8 sm:py-0">
        <motion.div
