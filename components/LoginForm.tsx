...
export default function LoginForm() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 w-full border border-gray-200">
      <div className="text-center mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-charcoal mb-2">Welcome Back</h1>
        <p className="text-sm sm:text-base text-charcoal">Sign in to your hApItech account</p>
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        >
          ...
          <span className="text-charcoal font-medium text-sm sm:text-base">Continue with Google</span>
        </button>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-magenta focus:border-transparent text-sm placeholder:text-gray-600 bg-white text-charcoal "
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              onChange={handleChange}
              required
              className="w-full px-3 sm:px-4 py-2 sm:py-3 pr-10 sm:pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-magenta focus:border-transparent text-sm placeholder:text-gray-600 bg-white text-charcoal "
      ...
      <div className="text-center mt-6">
        <p className="text-xs sm:text-sm text-charcoal ">
          ...
          <Link href="/auth/signup" className="text-magenta hover:text-orange font-semibold transition-colors">
            Sign up
          </Link>
        </p>
      </div>
