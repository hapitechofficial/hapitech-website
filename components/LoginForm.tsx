  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-charcoal">Sign in to your hApItech account</p>
      </div>
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center px-4 py-3 border-2 border-gray-400 bg-white rounded-lg hover:bg-gray-100 transition-colors"
        >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end">
          <Link
            ...
            className="text-magenta hover:text-orange text-sm transition-colors"
          >
            Forgot password?
          </Link>
        </div>
